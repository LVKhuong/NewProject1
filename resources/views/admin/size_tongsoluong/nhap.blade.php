...
@section('noidung')
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">THÊM MỚI KÍCH THƯỚC VÀ TỔNG SỐ LƯỢNG</h6>
        </div>
        ...
        <!-- Card Body -->
        <div class="card-body">
            <form action="{{ route('size_tongsoluong.store') }}" method="POST">
                @csrf
                <div class="input-group mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="tongsoluong" id="exampleFormControlInput1">
                      </div>
                    <input type="hidden" name="id_mausac" value="{{ $mausac->id }}">
                </div>
