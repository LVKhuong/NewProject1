...
@section('noidung')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('nguoidung.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-3 col-sm-6">
                        ...
                        <input type="password" class="form-control" id="basic-url" name="password"
                            aria-describedby="basic-addon6" value="{{ $data->password }}">
                    </div>
                    ...
                    <div class="input-group mb-3 col-sm-6">
                        ...
                        <input type="password" class="form-control" id="basic-url" name="repassword"
                            aria-describedby="basic-addon8" value="{{ $data->password }}">
                    </div>
