...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('mausac.update', $mausac->id) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            <div class="row">
                <div class="input-group mb-3 col-sm-6">
                    ...
                    <input type="text" class="form-control" id="basic-url" name="ten" value="{{ $mausac->ten }}"
                ...
                <div class="input-group mb-3 col-sm-6">
                    ...
                    <input type="file" class="form-control" id="basic-url" name="file_mausac" aria-describedby="basic-addon3">
                </div>
            </div>
