...
@section('timkiem')
    <form method="get" action="{{ route('thuonghieu.index') }}"
...
@section('noidung')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Thương hiệu</h6>
        </div>
        <div class="card-body ">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $value)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('thuonghieu.destroy', $value->id) }}" method="POST">
                                        @csrf @method('DELETE')

                                        <a href="{{route('thuonghieu.edit', $value->id)}}"
